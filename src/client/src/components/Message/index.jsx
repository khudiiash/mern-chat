    ...
    >
      <div className="message__content" style={{maxWidth: isMobile? '60vw' : '440px'}}>
        ...
        <div className="message__info">
          {(text || isTyping) && (
            <div className="message__bubble" style={{background: isText ? (isMe ?'#8f8f8f2d':'linear-gradient(to right, #355b7d79, #6c5b7b75, #c06c8431)') : countEmojies < 3 ? 'rgba(0,0,0,0)':(isMe ?'#8f8f8f2d':'linear-gradient(to right, #355b7d79, #6c5b7b75, #c06c8431)'), boxShadow: isText ? '0px 4px 14px rgba(0, 0, 0, 0.055)': countEmojies < 3 ? 'none':'0px 4px 14px rgba(0, 0, 0, 0.055)'}}>
              {text && (
